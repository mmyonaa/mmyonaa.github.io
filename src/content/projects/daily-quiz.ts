...
export const ko: ProjectText = {
  ...
  highlights: [
    '필기 875문항 · 실기 67문항 · 개념 주제 137개 — 블로그 개념 글 기반 LLM 생성',
    '실기 필답 자동 채점 — 표기 요동 정규화 · 동의어 허용 표기 목록',
    '간격 반복 오답노트 — 1일 → 3일 → 7일을 통과해야 졸업',
    '시험 2종을 화면 한 벌로 — 채점 형식 · 영역 · 저장 키만 분기',
    'zod 스키마 발행 게이트 — 스키마 위반 · 미존재 주제 참조는 빌드 실패',
  ],
  techNotes: [
    {
      title: '실기 필답 자동 채점',
