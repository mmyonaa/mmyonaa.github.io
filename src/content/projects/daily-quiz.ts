...
export const ko: ProjectText = {
  ...
  highlights: [
    '필기 875문항 · 실기 67문항 · 개념 주제 137개 — 기출 복제 없이 블로그 개념 글 기반으로 LLM 생성, 전 문항 난이도 라벨',
...
export const en: ProjectText = {
  ...
  highlights: [
    '875 written + 67 practical questions and 137 concept topics — all original — generated by an LLM from the blog concept posts rather than copied from past papers — every item difficulty-labeled',
