...
export const ko: ProjectText = {
  ...
  "description": "APOC Play(3D·인터랙티브 콘텐츠 공유 플랫폼)의 리뉴얼을 맡아 홈·검색·콘텐츠 상세·마이페이지 등 주요 화면을 새 디자인에 맞춰 전면 개선하고, 컴포넌트 기반으로 재구성했습니다.",
  "overview": [
    "APOC Play는 3D·인터랙티브 콘텐츠를 게시하고 감상하는 플랫폼입니다. 홈·검색·콘텐츠 상세·마이페이지·작가 페이지를 새 디자인에 맞춰 개편하고, 반복 UI를 공통 컴포넌트로 정리했습니다."
  ],
  "highlights": [
    "이용자 주요 화면 개편과 공통 컴포넌트·가이드 정리",
    "팔로우·알림·좋아요·저장·댓글·공유 화면 구현",
    "APOC Studio 편집 화면 연동과 한·영 지원"
  ],
  "techNotes": [
    {
      "title": "컴포넌트 기반 리뉴얼·리팩토링",
      "body": "홈·검색·콘텐츠 상세·마이페이지를 새 디자인에 맞춰 구현했습니다. 반복되는 카드·리스트·모달은 공통 컴포넌트로 분리하고, 스타일과 사용 방법을 가이드로 정리했습니다. 기존 기능을 새 컴포넌트로 옮기면서 화면별 중복 구현을 줄였습니다."
    },
    {
      "title": "콘텐츠 플랫폼 화면 구성",
...
export const en: ProjectText = {
  ...
  highlights: [
    'Full renewal of the APOC Play platform — home, search, content detail, my page, creator',
    'Extracted repeated UI into shared components — design system and component guide',
