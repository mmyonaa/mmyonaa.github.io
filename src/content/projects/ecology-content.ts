...
export const ko: ProjectText = {
  ...
  "description": "현장 해설 프로그램 참여를 이미지 인식으로 인증하고, 단계별 인증서·카카오 기프티콘 발송과 관리자 통계·정산까지 구현한 참여 인증제 디지털 콘텐츠 서비스.",
  "imageNote": "화면 속 해설 콘텐츠(일러스트·교안)는 별도 제작팀의 저작물입니다 — 본 작업 범위는 콘텐츠 플레이·활동 기록·인증 플랫폼 개발입니다.",
  "overview": [
    "국립생태원 방문자가 해설 프로그램 참여를 인증하고 인증서·기프티콘을 받는 서비스입니다. 콘텐츠 서비스와 관리자 시스템을 단독 설계·개발했으며, 별도로 제작된 APOC 콘텐츠를 iframe으로 연동했습니다."
  ],
  "highlights": [
    "이미지 인식과 직원 코드로 참여 인증 · 누적 단계별 인증서 발급",
    "조건 충족 시 기프티콘 자동 발송과 관리자 일괄 발송",
    "참여·만족도 통계와 엑셀 내보내기"
  ],
  "techNotes": [
    {
    ...
    {
      "title": "인앱 브라우저 우회",
      "body": "방문자는 주로 카카오 기프티콘 링크로 진입하고 완료 인증에 이미지 인식(카메라)을 쓰는데, 카카오·네이버·인스타그램 인앱 브라우저에서는 이런 기능이 제한될 수 있습니다. userAgent로 인앱 환경을 감지하면 외부 브라우저로 열도록 유도했고(카카오는 kakaotalk://web/openExternal 스킴), 안드로이드/iOS를 분기해 안내 UI를 함께 노출했습니다."
    }
  ]
}
...
export const en: ProjectText = {
  ...
  overview: [
    ...
    'I designed and built both the content service and the admin system solo. A Kakao gifticon is sent automatically once conditions are met, and admins run bulk sends, monthly stats, and satisfaction-survey Excel exports all in one place.',
  ],
  highlights: [
