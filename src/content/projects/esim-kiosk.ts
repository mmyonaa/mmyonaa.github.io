...
export const ko: ProjectText = {
  ...
  description:
    '무인 eSIM 판매 키오스크. Vue 키오스크 웹을 주도적으로 개발하고, Android 앱의 프린터·결제·다국어 인코딩 등 하드웨어 연동 기능을 담당했습니다.',
  overview: [
    '나리타 · 하네다 공항 2곳에 4대를 배치해 약 6개월간 무인으로 가동한 eSIM 키오스크입니다. 여행자가 직접 구매·발급받습니다. 대륙·국가·상품 선택부터 결제, eSIM QR 발급, 영수증 출력·이메일 전송까지의 흐름을 키오스크 환경에 맞게 구현했습니다. 판매 eSIM 상품은 30개국 이상을 커버하지만 키오스크 자체는 일본 매장 전용(JPY)이며, 결제 단말로 카드 · QR · NFC 태그 결제를 지원합니다. 개발 후 일본 현지에서 초기 운영까지 직접 담당했습니다.',
    '화면은 Vue 3 PWA로 만들어 키오스크 웹을 주도적으로 개발했고, 이를 Android(Kotlin) WebView 앱으로 감싸 단말에서 구동합니다. 앱 기반은 팀이 함께 만들었고, 저는 그 위에서 프린터·결제·인코딩·무인 운영 관련 하드웨어 기능을 개선·확장하는 역할을 맡았습니다.',
  ...
  highlights: [
    ...
    '공항 2곳 · 4대 · 약 6개월 무인 가동 — 현장 세팅부터 초기 운영·실시간 이슈 대응까지 담당 (판매 eSIM 상품 30개국+)',
  ],
  techNotes: [
    {
...
export const en: ProjectText = {
  ...
  photosNote: [
    ...
    'Two airports · four units · about six months of unattended operation — after development, I handled the on-site setup, initial operation, and real-time response to field issues such as paper-outs and network drops, in Japan.',
  ],
