...
export const ko: ProjectText = {
  ...
  overview: [
    '일본 현지 매장에 설치돼 여행자가 직접 eSIM을 구매·발급받는 무인 키오스크입니다. 대륙·국가·상품 선택부터 결제, eSIM QR 발급, 영수증 출력·이메일 전송까지의 흐름을 키오스크 환경에 맞게 구현했습니다. 판매 eSIM 상품은 30개국 이상을 커버하지만 키오스크 자체는 일본 매장 전용(JPY)이며, 결제 단말로 카드·QR·NFC 태그 결제를 지원합니다. 개발 후 일본 현지에서 초기 운영까지 직접 담당했습니다.',
  ...
  highlights: [
    ...
    '일본 현지 매장 무인 운영 세팅부터 초기 운영·실시간 이슈 대응까지 담당 (판매 eSIM 상품 30개국+)',
  ],
  techNotes: [
    {
