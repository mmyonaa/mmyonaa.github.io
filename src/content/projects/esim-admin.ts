...
export const ko: ProjectText = {
  ...
  "techNotes": [
    ...
    {
      "title": "다국가 · 다통화 운영",
      "body": "vue-i18n으로 한/영/일 3개 언어를 지원하고 상품명·상품설명 번역 기능을 붙였습니다. moment-timezone으로 현지 타임존을 UTC와 변환해 정산·주문 날짜를 처리하고, 통화·기기별로 결제 게이트웨이(PG) 선택지를 동적으로 필터링했으며, 포인트는 통화별 적립률로 관리했습니다."
    },
    {
      "title": "다국어 입력 검증 정규식",
