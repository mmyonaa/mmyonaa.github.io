...
const projectText: Record<string, ProjectText> = {
  ...
  'ecology-content': {
    ...
    description:
      'iframe 콘텐츠 플레이와 활동 기록·설문 시스템, 카카오 기프티콘 자동 발송을 구현한 디지털 콘텐츠 서비스. (팜피 재직 중 회사 프로젝트)',
    highlights: [
  ...
  'guseong-content': {
    ...
    description:
      '학생/교사 권한별 맞춤 UI와 컨텐츠 시청 기록, 교사용 학생 관리 기능을 구현한 초등 디지털 리터러시 컨텐츠 사이트. (팜피 재직 중 회사 프로젝트)',
    highlights: [
