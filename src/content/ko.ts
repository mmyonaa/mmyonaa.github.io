...
const projectText: Record<string, ProjectText> = {
  ...
  'ecology-content': {
    ...
    description:
      'iframe 콘텐츠 플레이와 활동 기록·설문 시스템, 카카오 기프티콘 자동 발송을 구현한 디지털 콘텐츠 서비스. 방문자가 콘텐츠를 즐기고 설문까지 참여하면 조건 충족 시 기프티콘이 자동 발송되고, 활동·설문 데이터는 관리자 시스템에서 운영·집계됩니다. 발송 실패에 대비한 상태 폴링·재시도 처리까지, 콘텐츠 서비스와 관리자의 시스템 설계부터 개발까지 1인으로 맡았습니다.',
    highlights: [
  ...
  'esim-admin': {
    ...
    architectureNotes: [
      '이 어드민이 상품·재고·업체·유저·정산을 관리하고, 온라인 커머스와 키오스크는 그 데이터를 공유 백엔드(Koa·PostgreSQL)로 받아 판매합니다. 즉 온·오프라인 판매가 하나의 운영·정산 체계로 묶입니다.',
    ],
    related: [
  ...
  'esim-kiosk': {
    ...
    overview: [
      '일본 현지 매장에 설치돼 여행자가 직접 eSIM을 구매·발급받는 무인 키오스크입니다. 대륙·국가·상품 선택부터 결제, eSIM QR 발급, 영수증 출력·이메일 전송까지의 흐름을 키오스크 환경에 맞게 구현했습니다.',
